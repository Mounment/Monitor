# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-08-18 07:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.IntegerField(default=300, verbose_name='告警时间(s)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.CharField(choices=[('email', 'Email'), ('sms', 'SMS'), ('script', 'SCRIPT')], default='email', max_length=64, verbose_name='动作类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monitored_by', models.CharField(choices=[('agent', 'Agent'), ('snmp', 'Snmp'), ('wget', 'Wget')], max_length=32, verbose_name='监控方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.IntegerField(choices=[(1, 'Infomation'), (2, 'Warning'), (3, 'Average'), (4, 'High'), (5, 'Diaster')], verbose_name='告警级别')),
                ('enabled', models.BooleanField(default=True)),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator_type', models.CharField(choices=[('eq', '='), ('gt', '>'), ('lt', '<')], max_length=32, verbose_name='运算符')),
                ...
                ('trigger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor.Trigger', verbose_name='所述触发器')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
